...
CREATE TABLE `captcha`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 539 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `comment`  (
  ...
  `author_id` varchar(25) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `comment_author_id` int(30) NULL DEFAULT NULL,
